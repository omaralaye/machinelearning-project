...
def check_model_fit(model, X_train, Y_train, X_val, Y_val, X_test, Y_test):
    # Predictions
...
if __name__ == "__main__":
    try:
        ...
        _, X_train, X_val, X_test, Y_train, Y_val, Y_test = edf.get_data_for_modeling()
        check_model_fit(model, X_train, Y_train, X_val, Y_val, X_test, Y_test)
